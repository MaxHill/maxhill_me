...
Status colors communicate feedback through danger, success, warning, info, and neutral states. Each status has both default and weak variants for different levels of emphasis.

<ColorTable category="Status" />
