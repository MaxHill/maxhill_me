...
export const SECTIONS: Section[] = [
    ...
    { id: "examples", label: "Examples", key: "x", isEmpty: ({ examples }) => examples.slice(1).length === 0 },
    { id: "properties", label: "Properties", key: "p", isEmpty: ({ comp }) => comp.properties.length === 0 },
    ...
    { id: "css-parts", label: "CSS Parts", key: "c", isEmpty: ({ comp }) => comp.cssParts.length === 0 },
];
