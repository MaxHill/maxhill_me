...
A search list that filters its children using fuzzy search. Supports keyword matching via `data-keywords`, debounced input, and exposes CSS custom states for styling based on search results.
