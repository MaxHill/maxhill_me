...
<CodeExample 
  ...
  <form class="form" id="event-form">
    ...
    <div id="event-log" style="margin-top: 1rem; padding: 1rem; background: var(--color-surface-raised); border-radius: 4px;">
