...
```html
<m-command name="toStart" command="navigate" commandfor="/design-system#hero" keys="<C-b>1">
  Default content
</m-command>
<m-command name="toComponents" command="navigate" commandfor="/design-system#doc-components" keys="<C-b>2">
  Default content
</m-command>
```
...
<dialog id="example-dialog">I'm an example dialog</dialog>
...
<div id="example-popover" popover>I'm a popover</div>
...
<input id="example-input" type="text" placeholder="Focus me with Command+b f" />
