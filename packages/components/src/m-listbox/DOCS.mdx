...
The default mode where arrow keys directly change the selection. This provides the quickest way to change selections with minimal keypresses.

**Keyboard behavior:**
- Arrow keys move selection directly
- Space/Enter also select the focused option
- Value is a string or null

### Single Focus

Arrow keys move focus only (visual highlight), and Space/Enter keys select the focused item. This mode gives users more control and is ideal for scenarios where accidental selection changes should be avoided.

**Keyboard behavior:**
- Arrow keys move focus (visual highlight) only
- Space/Enter select the focused option
- Value is a string or null

### Multiple

Enables multi-selection where users can select multiple options. Arrow keys move focus, and Space/Enter toggle selection state.

**Keyboard behavior:**
- Arrow keys move focus only
- Space/Enter toggle individual items
- Shift + Arrow keys for extended selection
...
**Event Detail:**
- `option`: The `MOption` element that was selected, or `null`
...
`m-listbox` supports full keyboard navigation following the ARIA listbox pattern. The behavior differs based on the selection mode:

**Single-Select Mode (default):**
- **Arrow Up/Down**: Move selection directly
- **Ctrl+P / Ctrl+N**: Navigate to previous/next option (Emacs-style)
- **Home**: Jump to first option and select it
- **End**: Jump to last option and select it
- **Space/Enter**: Select focused option

**Single-Focus Mode:**
- **Arrow Up/Down**: Move focus (visual highlight) only
- **Ctrl+P / Ctrl+N**: Navigate to previous/next option (Emacs-style)
- **Home**: Jump to first option (focus only)
- **End**: Jump to last option (focus only)
- **Space/Enter**: Select the focused option

**Multiple Mode:**
- **Arrow Up/Down**: Navigate between options (focus only)
- **Ctrl+P / Ctrl+N**: Navigate to previous/next option (Emacs-style)
- **Home**: Jump to first option
- **End**: Jump to last option
- **Space/Enter**: Toggle selection of focused option
- **Shift + Arrow Keys**: Extended selection
