...
<CodeExample html={`<m-listbox name="fruits" multiple>
  <m-option value="apple">Apple</m-option>
  <m-option value="pear">Pear</m-option>
  <m-option value="orange">Orange</m-option>
  <m-option value="banana">Banana</m-option>
...
<CodeExample html={`<m-listbox name="preselected-fruit-1">
  <m-option value="apple">Apple</m-option>
...
<CodeExample html={`<m-listbox name="preselected-fruit-2" value="orange">
  <m-option value="apple">Apple</m-option>
  <m-option value="pear">Pear</m-option>
  <m-option value="orange">Orange</m-option>
</m-listbox>`} />
...
<CodeExample html={`<m-listbox name="disabled-fruit" disabled>
  <m-option value="apple">Apple</m-option>
  <m-option value="pear" selected>Pear</m-option>
  <m-option value="orange">Orange</m-option>
</m-listbox>`} />
...
<CodeExample html={`<form id="fruit-form" class="stack" data-gap="2">
...
- [`<m-option>`](/components/m-option) - Individual listbox item
